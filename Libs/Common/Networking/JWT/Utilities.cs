    ...
    public sealed class Utilities {
        public static IReturnCode<string> Sign(IWebToken token, byte[] key) {
            ...
            try {
                ...
                rc.Errors.Add(new CommonError(ErrorCodes.SIGNING_TOKEN_FAILED, HttpStatusCode.InternalServerError, ex));
            }
            ...
            try {
                ...
                if (rc.Success) {
                    if (signature.Equals(token.Signature) == false) {
                        rc.Errors.Add(new CommonError(ErrorCodes.TOKEN_SIGNATURE_DO_NOT_MATCH, HttpStatusCode.InternalServerError));
                    }
                }
            }
            catch (Exception ex) {
                rc.Errors.Add(new CommonError(ErrorCodes.VALIDATE_TOKEN_FAILED, HttpStatusCode.InternalServerError, ex));
            }
        ...
        public static IReturnCode<string> ConvertToBase64(IDictionary<string, string> data) {
            ...
            try {
                ...
                if (string.IsNullOrEmpty(base64String)) {
                    rc.Errors.Add(new CommonError(ErrorCodes.BAD_STATUS_CODE_RETURNED, HttpStatusCode.InternalServerError));
                }
            }
            catch (Exception ex) {
                rc.Errors.Add(new CommonError(ErrorCodes.CONVERT_TO_BASE_64_FAILED, HttpStatusCode.InternalServerError, ex));
            }
        ...
        public static IDictionary<string, string>? ConvertFromBase64(string base64String) {
            ...
            try {
                ...
                rc.Errors.Add(new CommonError(ErrorCodes.CONVERT_FROM_BASE_64_FAILED, HttpStatusCode.InternalServerError, ex));
            }
